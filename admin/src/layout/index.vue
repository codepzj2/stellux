<template>
  <div>
            ...
            <DialogPanel class="relative mr-16 flex w-full max-w-xs flex-1">
              ...
              <div class="flex grow flex-col gap-y-5 overflow-y-auto bg-white px-6 pb-4">
                <div class="flex h-16 shrink-0 items-center">
                  <img class="h-8 w-auto" src="/logo.png" alt="stellux" />
                </div>
                <nav class="flex flex-1 flex-col">
                  <ul role="list" class="flex flex-1 flex-col gap-y-7">
                    ...
                    <li>
                      <div class="text-xs/6 font-semibold text-gray-400">你的团队</div>
    ...
    <div class="lg:pl-72">
      <div class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-white px-4 shadow-xs sm:gap-x-6 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
          <form class="grid flex-1 grid-cols-1" action="#" method="GET">
            <input type="search" name="search" aria-label="搜索" class="col-start-1 row-start-1 block size-full bg-white pl-8 text-base text-gray-900 outline-hidden placeholder:text-gray-400 sm:text-sm/6" placeholder="搜索" />
            ...
            <Menu as="div" class="relative">
              <MenuButton class="-m-1.5 flex items-center p-1.5">
                ...
                <span class="hidden lg:flex lg:items-center">
                  <span class="ml-4 text-sm/6 font-semibold text-gray-900" aria-hidden="true">汤姆·库克</span>
      ...
      <main class="py-10 border-t border-gray-200">
...
const navigation = [
  { name: '仪表盘', href: '#', icon: HomeIcon, current: true },
  { name: '用户管理', href: '/user/list', icon: UsersIcon, current: false },
  { name: '项目管理', href: '#', icon: FolderIcon, current: false },
  { name: '日历', href: '#', icon: CalendarIcon, current: false },
  { name: '文档', href: '#', icon: DocumentDuplicateIcon, current: false },
  { name: '报告', href: '#', icon: ChartPieIcon, current: false },
]
const teams = [
