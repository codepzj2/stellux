<template>
  ...
  <!-- 新增弹窗 -->
  <a-modal v-model:open="createModalOpen" title="新增标签" @ok="handleCreateOk">
    <a-form ref="createFormRef" :model="createForm" :rules="createRules">
      <a-form-item label="标签类型" name="label_type">
  ...
  <!-- 编辑弹窗 -->
  <a-modal v-model:open="editModalOpen" title="编辑标签" @ok="handleEditOk">
