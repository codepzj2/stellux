<template>
  ...
  >
    <div class="sm:mx-auto sm:w-full sm:max-w-md">
      <img class="mx-auto h-10 w-auto" src="/logo.png" alt="stellux" />
    </div>
        ...
        <form class="space-y-6" action="#" method="POST">
          ...
          <div>
            <button
              ...
              :class="[
                'flex w-full justify-center rounded-md px-3 py-1.5 text-sm/6 font-semibold text-white shadow-xs transition-colors duration-200 cursor-pointer',
        ...
        <div>
          ...
          <div class="mt-6 grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span class="text-sm/6 font-semibold">谷歌</span>
            </a>
