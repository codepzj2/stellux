...
// NewGin 初始化gin服务器
func NewGin(userHdl *user.Handler, postHdl *post.Handler, labelHdl *label.Handler, fileHdl *file.Handler, documentHdl *document.Handler, middleware []gin.HandlerFunc) *gin.Engine {
	router := gin.New()
